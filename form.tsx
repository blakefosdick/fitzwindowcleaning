...
const FormSpark: ComponentType<Props> = withCSS<Props>(
    function FormSpark({
        ...
        const [windowType, setWindowType] = useState("Exterior Only")
        const [isWindowCountError, setWindowCountError] = useState(false)
        const [isWindowTypeError, setWindowTypeError] = useState(false)
        ...
        const validateForm = useCallback(() => {
            ...
            if (!windowCount || isNaN(Number(windowCount))) {
                setWindowCountError(true)
                error = true
            }
        ...
        const handleWindowCountChange = useCallback((event: any) => {
            setWindowCountError(false)
            setWindowCount(event.target.value)
        }, [])

        const handleWindowTypeChange = useCallback((event: any) => {
                                ...
                                {withName && (
                                    <input
                                        ...
                                        style={{
                                            ...
                                            color: inputs.color,
                                            boxShadow: `inset 0 0 0 1px ${isNameError
                                                    ? inputs.error
                                                    : "transparent"
                                                }`,
                                        }}
                                ...
                                {withEmail && (
                                    <input
                                        ...
                                        style={{
                                            ...
                                            background: inputs.fill,
                                            color: inputs.color,
                                            boxShadow: `inset 0 0 0 1px ${isEmailError
                                                    ? inputs.error
                                                    : "transparent"
                                                }`,
                                        }}
                                    ...
                                    <input
                                        ...
                                        style={{
                                            ...
                                            background: inputs.fill,
                                            color: inputs.color,
                                            boxShadow: `inset 0 0 0 1px ${isWindowCountError ? inputs.error : "transparent"
                                                }`,
                                        }}
                                    />
                                    ...
                                    <select
                                        ...
                                        style={{
                                            ...
                                            background: inputs.fill,
                                            color: inputs.color,
                                            boxShadow: `inset 0 0 0 1px ${isWindowTypeError ? inputs.error : "transparent"
                                                }`,
                                        }}
                                    >
                        ...
                        {withMessage && (
                            <textarea
                                ...
                                style={{
                                    ...
                                    fontSize,
                                    color: inputs.color,
                                    boxShadow: `inset 0 0 0 1px ${isMessageError
                                            ? inputs.error
                                            : "transparent"
                                        }`,
                                }}
